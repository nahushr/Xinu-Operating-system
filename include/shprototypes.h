...
extern shellcmd xsh_keyvalue(int nargs, char *args[]);
 /* command of xsh_hello file*/ 
extern shellcmd xsh_hello(int, char*[]);

/*test cases for key value pairs*/
extern shellcmd xsh_big(int, char*[]);
extern shellcmd xsh_large(int, char*[]);
extern shellcmd xsh_long(int, char*[]);
extern shellcmd xsh_small(int, char*[]);
extern shellcmd xsh_xlarge(int, char*[]);
